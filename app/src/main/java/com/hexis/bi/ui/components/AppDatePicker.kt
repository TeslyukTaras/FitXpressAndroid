...
fun AppDatePicker(
    ...
    onDismissRequest: () -> Unit,
    onReset: () -> Unit,
    onSelect: (startDateMillis: Long?, endDateMillis: Long?) -> Unit,
    modifier: Modifier = Modifier,
    isRangeValid: Boolean = true,
    rangeErrorText: String? = null,
) {
    val colors = appDatePickerColors()
            ...
            CompositionLocalProvider(LocalContentColor provides MaterialTheme.colorScheme.onBackground) {
                DateRangePicker(
                    ...
                    modifier = Modifier
                        ...
                        .heightIn(max = dimensionResource(R.dimen.app_date_range_picker_max_height)),
                    showModeToggle = false,
                    colors = colors,
                )
            }

            if (!isRangeValid && rangeErrorText != null) {
                Text(
                    text = rangeErrorText,
            ...
            Row(
                modifier = Modifier
                    ...
                    .padding(
                        ...
                        top = dimensionResource(R.dimen.spacer_xs),
                        bottom = dimensionResource(R.dimen.spacer_s),
                    ),
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun appDatePickerColors() = DatePickerDefaults.colors(
