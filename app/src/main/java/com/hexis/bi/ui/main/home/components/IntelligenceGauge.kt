...
internal fun IntelligenceGauge(
    ...
    val strokeWidth = dimensionResource(R.dimen.home_intelligence_gauge_stroke)
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            if (filledSweep > 0f) {
                val brush = Brush.sweepGradient(
                    0f to gaugeLow,
                    IntelligenceConstants.GAUGE_GRADIENT_LEFT_STOP to gaugeLow,
                    IntelligenceConstants.GAUGE_GRADIENT_TOP_STOP to gaugeMid,
                    IntelligenceConstants.GAUGE_GRADIENT_RIGHT_STOP to gaugeHigh,
                    center = center,
                )
                drawArc(
                    brush = brush,
