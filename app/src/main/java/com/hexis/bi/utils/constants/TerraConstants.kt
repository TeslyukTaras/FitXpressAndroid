...
internal object TerraProviders {
    ...
    val WEARABLE_CODES: Set<String> = setOf(
        OURA, WHOOP, FITBIT, GARMIN, POLAR, COROS, SUUNTO, WITHINGS, ZEPP, BIOSTRAP,
        HEALTHGAUGE, INBODY, SOMNOFY, CORE, MOXY, PUL, OMRON, CARDIOMOOD,
    )

    val APP_CODES: Set<String> = setOf(
        GOOGLE, PELOTON, WAHOO, HAMMERHEAD, XOSS, BRYTONSPORT, LEZYNE, TECHNOGYM,
        CONCEPT2, DECATHLON, CATAPULTONE, TRIDOT, ULTRAHUMAN, TRAININGPEAKS, TRAINERROAD,
        FINALSURGE, ELITEHRV, HEVY, TRAINXHALE, TRAINASONE, ROUVY, ZWIFT, RIDEWITHGPS,
        MAPMYTRACKS, MAPMYFITNESS, KOMOOT, CYCLINGANALYTICS, VELOHERO, XERT, TREDICT,
        UNDERARMOUR, CLUE, FLO, WGER, NUTRACHECK, MACROSFIRST, MYMACROSPLUS, MYFITNESSPAL,
        CRONOMETER, FATSECRET, EATTHISMUCH, KETOMOJOEU, KETOMOJOUS, BODITRAX,
    )
}
