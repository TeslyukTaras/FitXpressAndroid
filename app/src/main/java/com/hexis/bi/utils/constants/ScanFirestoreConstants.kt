...
object ScanFirestoreConstants {
    ...
    const val FIELD_BODY_PROGRESS_BEFORE_MEASUREMENT_ID = "bodyProgressBeforeMeasurementId"
    const val FIELD_BODY_PROGRESS_ID = "bodyProgressId"
    const val FIELD_BODY_PROGRESS_MODEL_URL = "bodyProgressModelUrl"
